# src/preprocessing/aggregate_tiles.py
...
import utilities as uu  # Import utility functions from utilities.py
...
1. Run for a specific date, tile, and dataset without uploading outputs:
   ...
   python aggregate_tiles.py --date 20240101 --tile_id 00N_110E --dataset osm_canals_density --no_upload

2. Run for a specific date, tile, and dataset with uploading outputs:

   python aggregate_tiles.py --date 20240822 --tile_id 00N_110E --dataset osm_canals_density

3. Run locally for all datasets and tiles for today's date:

   python aggregate_tiles.py --run_local

4. Run using Coiled cluster for the 'grip_density' dataset:

   python aggregate_tiles.py --dataset grip_density

5. Run for a specific tile across all datasets:

   python aggregate_tiles.py --tile_id 00N_110E
   python aggregate_tiles.py --tile_id 00N_110E
