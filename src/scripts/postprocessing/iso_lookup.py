...
iso_lookup.py
-------------
Hard‑coded mapping of FAOSTAT “Area” names → ISO‑3 country codes.

Regional aggregates map to `None` so the calling script can drop them.
"""

ISO_LOOKUP: dict[str, str | None] = {
    # ---------- A ----------
    "Afghanistan": "AFG",
    "Albania": "ALB",
    "Algeria": "DZA",
    ...
    "Zimbabwe": "ZWE",
    # -----------------------------------------------------------------
    # Regional & special aggregates – map to None
    # -----------------------------------------------------------------
    "World": None,
    "Africa": None,
    "Americas": None,
