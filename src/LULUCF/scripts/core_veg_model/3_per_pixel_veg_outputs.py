...
Local test:
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -bb 10 49 11 50 -cs 1 --no_upload -yr 2000 2024 --input_date YYYYMMDD
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -bb 20 -1 21 0 -cs 1 --no_upload -yr 2000 2024 --input_date YYYYMMDD
...
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -cn LULUCF_postprocessing -bb 10 49 11 50 -cs 1 --no_upload -yr 2000 2024 --input_date YYYYMMDD
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -cn LULUCF_postprocessing -bb 20 -1 21 0 -cs 1 -yr 2000 2024 --input_date YYYYMMDD
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -cn LULUCF_postprocessing -cshp s3://gfw2-data/climate/AFOLU_flux_model/fishnet_1x1deg/20250429/fishnet_GADM41_1x1deg__spatial_join_intersect__20250428__center_in.shp -f 1 -yr 2000 2024 --input_date YYYYMMDD
...
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -cn LULUCF_postprocessing -cshp s3://gfw2-data/climate/AFOLU_flux_model/fishnet_1x1deg/20250429/fishnet_GADM41_1x1deg__spatial_join_intersect__20250428__center_in__1884_test_features.shp -yr 2000 2024 --input_date YYYYMMDD -ln "Per-pixel outputs for 1884-feature shapefile for model v0.4.0."

Full run (1x1 deg chunk needs a 32GB worker):
python -m src.utilities.create_cluster -n 100 -t 1 -m 32 -cn LULUCF_postprocessing
python -m src.LULUCF.scripts.core_veg_model.3_per_pixel_veg_outputs -cn LULUCF_postprocessing -cshp s3://gfw2-data/climate/AFOLU_flux_model/fishnet_1x1deg/20250429/fishnet_GADM41_1x1deg__spatial_join_intersect__20250428__center_in.shp -yr 2000 2024 --input_date YYYYMMDD -ln "This is intended to be the definitive global run."
