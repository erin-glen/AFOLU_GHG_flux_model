...
Local test:
python -m src.LULUCF.scripts.core_veg_model.2_summative_veg_outputs -bb 10 49 11 50 -cs 1 --no_upload -yr 2000 2024 --input_date YYYYMMDD
...
python -m src.LULUCF.scripts.core_veg_model.2_summative_veg_outputs -cn LULUCF_postprocessing -bb 10 49 11 50 -cs 1 -yr 2000 2024 --input_date YYYYMMDD
python -m src.LULUCF.scripts.core_veg_model.2_summative_veg_outputs -cn LULUCF_postprocessing -bb 20 -1 21 0 -cs 1 -yr 2000 2024 --input_date YYYYMMDD
