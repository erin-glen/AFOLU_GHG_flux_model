...
Local test:
python -m src.LULUCF.scripts.core_veg_model.5_create_mega_zarr -yr 2000 2024 --first_folders_to_process 2 --first_10x10s_to_process 2 --input_date YYYYMMDD --run_local
