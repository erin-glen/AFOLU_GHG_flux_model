...
def preprocess_and_upload_smoothed_mangrove_data(bounds, download_dict_with_data_types, area_dict_with_data_types, is_final, no_upload, output_folders, stage):
