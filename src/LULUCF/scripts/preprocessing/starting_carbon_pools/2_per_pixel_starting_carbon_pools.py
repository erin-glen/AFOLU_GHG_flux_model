...
Local:
python -m src.LULUCF.scripts.preprocessing.starting_carbon_pools.2_per_pixel_starting_carbon_pools -bb 10 49 11 50 -cs 1 --no_upload --year 2000 --input_date 20250626
