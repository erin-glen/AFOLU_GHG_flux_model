...
python -m src.LULUCF.scripts.preprocessing.starting_carbon_pools.2_aggregate_outputs_to_10x10deg -bb 23 -4 24 -3 --run_local --no_upload -mt standard -mpd global -fv 1 -ft 1 --input_date YYYYMMDD
...
python -m src.LULUCF.scripts.preprocessing.starting_carbon_pools.2_aggregate_outputs_to_10x10deg -cn starting_carbon_pools -bb 23 -4 24 -3 -fv 2 -ft 2 -mt standard -mpd global -mcstn starting_carbon_pools_2015_1x1_deg_1x1_chunk_statistics_20260128_12_34_19__KEEP.xlsx  --input_date YYYYMMDD

Coiled small tests:
python -m src.utilities.create_cluster -n 1 -t 1 -m 32 -cn starting_carbon_pools
python -m src.LULUCF.scripts.preprocessing.starting_carbon_pools.2_aggregate_outputs_to_10x10deg -cn starting_carbon_pools -bb -64 -22 -63 -21 -fv 3 -ft 3 -mt standard -mpd global -mcstn starting_carbon_pools_2015_1x1_deg_1x1_chunk_statistics_20260128_12_34_19__KEEP.xlsx --input_date YYYYMMDD

Coiled Cerrado test (174 features):
python -m src.utilities.create_cluster -n 20 -t 1 -m 32 -cn starting_carbon_pools
python -m src.LULUCF.scripts.preprocessing.starting_carbon_pools.2_aggregate_outputs_to_10x10deg -cn starting_carbon_pools -mt standard -mpd global -mcstn starting_carbon_pools_2015_1x1_deg_1x1_chunk_statistics_20260128_12_34_19__KEEP.xlsx -cshp s3://gfw2-data/climate/AFOLU_flux_model/fishnet_1x1deg/20250429/fishnet_GADM41_1x1deg__spatial_join_intersect__20250428__center_in__Cerrado_center_in.shp --input_date YYYYMMDD
...
def main(cluster_name, input_date, model_type, run_local, no_log, no_upload, model_chunk_stats_table_name, chunk_shapefile_uri=False, bounding_box=None,
    ...
    full_list_of_vars = [cn.agc_LC_masked_dens_pattern]
