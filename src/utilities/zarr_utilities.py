...
def create_mega_zarr_path(zarr_basic_path, chunk_size_pixels, interval_type, model_type, model_path_description,
                          run_date, main_logger):

    # Sets the output zarr location based on the model run
    mega_zarr_path = zarr_basic_path.replace(cn.model_version_type_description_placeholder, f"version_{cn.veg_model_version_underscore}__{model_type}__{model_path_description}")
